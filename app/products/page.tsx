...
const products = [
  ...
  },
  {
    ...
    features: [
      "Compact integrated cash management for limited counter space",
      "Guided payment flow with light cues and display prompts",
      "Full euro coin recycling from €0.01 to €2.00",
      "Secure closed handling with controlled access",
      "Adaptable for attended or unattended lanes",
      "Multi-currency configuration where required",
    ],
  },
  {
